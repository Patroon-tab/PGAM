...
butt.grid(row = 27, column = 0)

mirror_bool = tk.IntVar()
tk.Checkbutton(window, text="mirror?", variable=mirror_bool).grid(row=25)
double_via_bool = tk.IntVar()
tk.Checkbutton(window, text="double via row?", variable=double_via_bool).grid(row=26)
...
"""
        ...
        points_straight = []
        straight_length = (D26 - (2*D22) - D16-(2*D9))/2
        point_straight_1 = endpoints[0]
        point_straight_2 = [point_straight_1[0]+straight_length, point_straight_1[1]]
        ...
        point_straight_5 = [point_straight_4[0]+D9, point_straight_2[1]]
        point_straight_6 = [point_straight_5[0]+straight_length, point_straight_5[1]] #Top curve start
        point_straight_7 = [point_straight_6[0], point_straight_6[1]-D7] #Bottom curve start
        point_straight_8 = [point_straight_5[0], point_straight_7[1]]
        point_straight_9 = [point_straight_4[0], point_straight_4[1]-D10]
        point_straight_10 = [point_straight_3[0], point_straight_3[1]-D10]
        point_straight_11 = [point_straight_2[0], point_straight_2[1]-D7]
        point_straight_12 = [point_straight_1[0], point_straight_1[1]-D7]
        ...
        left_side_plane.append([point_straight_2[0], point_straight_2[1]+ ((D8-D7)/2)])
        left_side_plane.append([point_straight_3[0], point_straight_3[1]+ ((D11-D10)/2)])
        left_side_plane.append([point_straight_4[0], point_straight_4[1]+ ((D11-D10)/2)])
        left_side_plane.append([point_straight_5[0], point_straight_5[1]+ ((D8-D7)/2)])

        right_side_plane.append([point_straight_2[0], point_straight_2[1]- ((D8-D7)/2)-D7])
        right_side_plane.append([point_straight_3[0], point_straight_3[1] -((D11-D10)/2)-D10])
        right_side_plane.append([point_straight_4[0], point_straight_4[1]- ((D11-D10)/2)-D10])
        right_side_plane.append([point_straight_5[0], point_straight_5[1]- ((D8-D7)/2)-D7])
        ...
        file.write("G36*\n")
        circle, endpoints = drawarc([(point_straight_6[0] + point_straight_7[0])/2,(point_straight_6[1] + point_straight_7[1])/2], D22, D7, segments_circle, "norm", "rightd")
        draw([(point_straight_6[0] + point_straight_7[0])/2,(point_straight_6[1] + point_straight_7[1])/2], "D02")
        for x in circle:
                
                draw(x, "D01")
        plt.show()

        left_side_plane.append([((D1+D26)/2)+(D8/2),0]) #Datapoint 25
        ...
        point_straight_1 = endpoints[0]
        point_straight_2 = [point_straight_1[0], point_straight_1[1]-D24+D5]
        point_straight_3 = [point_straight_2[0] - (D7-D6), point_straight_2[1]]
        point_straight_4 = [point_straight_3[0], 0]
        point_straight_5 = [point_straight_4[0]-D6, 0]
        point_straight_6 = [point_straight_5[0], D5]
        point_straight_7 =  [point_straight_6[0]- (D7-D6), D5]
