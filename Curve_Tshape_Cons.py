...
E27 = inputd(27, D27/1000)
E28 = inputd(28, D28/1000)
E29 = inputd(29, D29/1000)
...
def overwrite():
        ...
        D27 = float(E27.get()) * 1000 * prefactor
        D28 = float(E28.get()) * 1000 * prefactor
        D29 = float(E29.get()) * 1000 * prefactor
